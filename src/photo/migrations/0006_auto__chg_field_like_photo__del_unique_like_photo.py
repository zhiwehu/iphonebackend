...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Like', fields ['photo']
        db.delete_unique('photo_like', ['photo_id'])


        # Changing field 'Like.photo'
        db.alter_column('photo_like', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photo.Photo']))

    def backwards(self, orm):

        # Changing field 'Like.photo'
        db.alter_column('photo_like', 'photo_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['photo.Photo'], unique=True))
        # Adding unique constraint on 'Like', fields ['photo']
        db.create_unique('photo_like', ['photo_id'])
