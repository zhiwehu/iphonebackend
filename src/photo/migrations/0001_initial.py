...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Like'
        db.create_table('photo_like', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('photo', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['photo.Photo'], unique=True)),
        ))
        db.send_create_signal('photo', ['Like'])

        # Adding model 'Comment'
        db.create_table('photo_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal('photo', ['Comment'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Like'
        db.delete_table('photo_like')

        # Deleting model 'Comment'
        db.delete_table('photo_comment')
