...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('photo_profile', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.birthday'
        db.alter_column('photo_profile', 'birthday', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
