...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdminNotification'
        db.create_table('photo_adminnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=1024)),
        ))
        db.send_create_signal('photo', ['AdminNotification'])


    def backwards(self, orm):
        # Deleting model 'AdminNotification'
        db.delete_table('photo_adminnotification')
    ...
    models = {
        ...
        'photo.adminnotification': {
            'Meta': {'object_name': 'AdminNotification'},
